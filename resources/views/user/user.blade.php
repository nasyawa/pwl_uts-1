                ...
                <table class="table table-bordered table-striped">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>{{$h->status}}</td>
                            <td>
                                <a href="{{ url('/user/'. $h->user.'/edit') }}" class="btn btn-sm btn-warning">Edit</a>
                                <a href="{{ url('/pendaftaran/'. $h->user.'/daftar') }}" class="btn btn-sm btn-primary">Daftar</a>
                                <form method="POST" action="{{ url('/user/'.$h->user) }}">
                                    @csrf
                                    @method('DELETE')
